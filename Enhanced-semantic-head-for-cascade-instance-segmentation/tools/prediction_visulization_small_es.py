...
checkpoint_file = '/home/hxr/fusion6/mmdetection-2.18.1/work_dirs/transformer_htc_r101_fpn_20e_coco_small/epoch_12.pth'
...
for img_info in img_infos:
    ...
    for ann in ann_infos:
        if ann['area'] > 96*96:
            save_path = '/home/hxr/fusion6/mmdetection-2.18.1/htc+es_train_small_val_predict_large/'
            is_large = True
            break
    if not is_large:
        save_path = '/home/hxr/fusion6/mmdetection-2.18.1/htc+es_train_small_val_predict_htc_small_midlle/'
