...
class HybridTaskCascadeRoIHead(CascadeRoIHead):
    ...
    def forward_dummy(self, x, proposals):
        ...
        if self.with_semantic:
            semantic_feat = self.semantic_head(x)[1]
        else:
            semantic_feat = None
        # bbox heads
    ...
    def simple_test(self, x, proposal_list, img_metas, rescale=False):
        ...
        # outputs = []
        if self.with_semantic:
            # mask_pred, semantic_feat, class_scores , trm_feat, fcn_feat = self.semantic_head(x)
            semantic_feat = self.semantic_head(x)[1]
        else:
            semantic_feat = None
        # outputs.append(semantic_feat)
        # outputs.append(fcn_feat)
        # outputs.append(trm_feat)
